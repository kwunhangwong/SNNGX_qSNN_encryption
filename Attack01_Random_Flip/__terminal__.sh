...
python3 __main__.py -nb 50 -nt 100 -q 8 -b 64 --Dataset "NMNIST" --Dpath '../../BSNN_Project/N-MNIST_TRAINING/dataset'
python3 __main__.py -nb 60 -nt 100 -q 8 -b 64 --Dataset "NMNIST" --Dpath '../../BSNN_Project/N-MNIST_TRAINING/dataset'
python3 __main__.py -nb 70 -nt 100 -q 8 -b 64 --Dataset "NMNIST" --Dpath '../../BSNN_Project/N-MNIST_TRAINING/dataset'
python3 __main__.py -nb 80 -nt 100 -q 8 -b 64 --Dataset "NMNIST" --Dpath '../../BSNN_Project/N-MNIST_TRAINING/dataset'
python3 __main__.py -nb 90 -nt 100 -q 8 -b 64 --Dataset "NMNIST" --Dpath '../../BSNN_Project/N-MNIST_TRAINING/dataset'
python3 __main__.py -nb 100 -nt 100 -q 8 -b 64 --Dataset "NMNIST" --Dpath '../../BSNN_Project/N-MNIST_TRAINING/dataset'
