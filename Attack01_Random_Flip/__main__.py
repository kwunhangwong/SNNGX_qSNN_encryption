...
parser.add_argument('--Dataset',type=str,metavar='Target dataset',default="NMNIST", 
                    help= 'Please input: 1. "NMNIST" 2. "MNIST" 3. "DVS128_Gesture", their corresponding model and loader will be selected automatically') 
...
if (target_dataset == "NMNIST"):
    ...
    weight_path = '../pretrained_weights_float32/pretrained_normal-mnist_ann_300e.t7'
    ...
    raise ValueError("Random Flipping main: Target dataset not recognized. (NMNIST/MNIST/DVS128_Gesture)")
